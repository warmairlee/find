...
<%@include file="/head.jsp" %>
  <div id="searchbar">
    <form action="${pageContext.request.contextPath }/servlet/myXWCaseListServlet" method="post">
...
<div id="contentbox">
<div id="myzl"><strong>我&nbsp;的&nbsp;招&nbsp;领</strong></div>
...
<a href="${pageContext.request.contextPath }/servlet/myZLCaseListServlet?curPage=1">首页</a>&nbsp;
<a href="${pageContext.request.contextPath }/servlet/myZLCaseListServlet?curPage=${curPage - point }">上一页</a>&nbsp;
<font color="#0080ff">当前第${curPage }页&nbsp;</font>
<a href="${pageContext.request.contextPath }/servlet/myZLCaseListServlet?curPage=${curPage + point }">下一页</a>&nbsp;
<a href="${pageContext.request.contextPath }/servlet/myZLCaseListServlet?curPage=${pageCount}">尾页</a>
</div>
