...
<meta charset="utf-8">
<title>发布寻物启事</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/fbxwqs.css">
</head>

<body>
<%@include file="/head.jsp" %>
<form action="${pageContext.request.contextPath}/servlet/XunwuServlet" method="post" enctype="multipart/form-data">
  <table width="600" height="440" border="0" align="center">
    <tbody>
      <tr>
        <td colspan="2" class="title">发布寻物启事</td>
      </tr>
      <tr>
        <td width="174">标题*</td>
        <td width="275">
      ...
      <tr>
        <td>物品描述*</td>
        <td>
          <textarea class="text" name="des" rows="6" ">${des }</textarea>
