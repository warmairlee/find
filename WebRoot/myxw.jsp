...
<div id="contentbox">
<div id="myxw"><strong>我&nbsp;的&nbsp;寻&nbsp;物</strong></div>
...
<a href="${pageContext.request.contextPath }/servlet/myXWCaseListServlet?curPage=1">首页</a>&nbsp;
<a href="${pageContext.request.contextPath }/servlet/myXWCaseListServlet?curPage=${curPage - point }">上一页</a>&nbsp;
<font color="#ff5809">当前第${curPage }页&nbsp;</font>
<a href="${pageContext.request.contextPath }/servlet/myXWCaseListServlet?curPage=${curPage + point }">下一页</a>&nbsp;
<a href="${pageContext.request.contextPath }/servlet/myXWCaseListServlet?curPage=${pageCount}">尾页</a>
</div>
